...
<div class="style">
<form action="editlocationsrv.php">
<div class="heading">Edit Location</div>
...
<label><span>Points of Interest:</span><input name="pointsOfInterest" class="select-field" value="<?php echo $row["pointsOfInterest"]?>" /></label>
<label><span>Country:</span><input name="country" class="select-field" value="<?php echo $row["country"]?>" /></label>
</br>
