...
<label><span>Found:</span><input name="found" class="select-field" value="<?php echo $row['found']?>" /></label>
<label><span>Uses:</span><input name="uses" class="select-field" value="<?php echo $row['uses']?>" /></label>
</br>
