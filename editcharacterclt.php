...
$sql = "SELECT * from Characters where id = " . $_REQUEST["id"];
...
<div class="style">
<form action="editcharactersrv.php">
<div class="heading">Edit Character</div>
<input type="hidden" name="id" value="<?php echo $row["id"]?>" />
<label><span>Name:</span><input name="name" class="select-field" value="<?php echo $row['name']?>"></label>
<label><span>Hometown:</span><input name="hometown" class="select-field" value="<?php echo $row['hometown']?>"></label>
<label><span>Appearances:</span><input name="appearances" class="select-field" value="<?php echo $row['appearances']?>"></label>
<label><span>Titles:</span><input name="titles" class="select-field" value="<?php echo $row['titles']?>"></label>
<label><span>Race:</span><input name="race" class="select-field" value="<?php echo $row['race']?>"></label>
<label><span>Gender:</span><input name="gender" class="select-field" value="<?php echo $row['gender']?>"></label>
</br>
