...
<div class="style">
<form action="editbosssrv.php">
<div class="heading">Edit Boss</div>
...
<label><span>Location:</span><input name="location" class="select-field" value="<?php echo $row["location"]?>" /></label>
<label><span>Spoils:</span><input name="spoils" class="select-field" value="<?php echo $row["spoils"]?>" /></label>
<label><span>Effective Weapon:</span><input name="effectiveWeapon" class="select-field" value="<?php echo $row["effectiveWeapon"]?>" /></label>
</br>
